...
public class LifeIndexesHolder extends BaseViewHolder<LifeIndexData> implements WeatherCallBack.LifeAdvice {
    ...
    @BindView(R2.id.lifeRecyclerView)
    RecyclerView mRecyclerView;
    @BindView(R2.id.life_advice)
    ...
    static final class LifeItemHolder extends BaseViewHolder<LifeItemData> {
        ...
        @BindView(R2.id.life_type)
        TextView lifeType;
        @BindView(R2.id.life_level)
        TextView lifeLevel;
        @BindView(R2.id.life_index_icon)
        ...
        @OnClick(R2.id.life_index_content)
        public void onClick() {
